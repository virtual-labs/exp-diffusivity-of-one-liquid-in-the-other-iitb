...
function a1_draw_all_components() {
    var sq = new Chemistry.Custome_image(burette, new Chemistry.Point(920, 470), 76, 562, canvas);
    sq.name = "burette";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(beaker, new Chemistry.Point(1250, 470), 335, 470, canvas);
    sq.name = "beaker";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(flask, new Chemistry.Point(1650, 470), 268, 466, canvas);
    sq.name = "flask";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(pipette, new Chemistry.Point(600, 470), 40, 536, canvas);
    sq.name = "pipette";
    scene.add(sq);
    var sq = new Chemistry.Custome_image(porous_cell, new Chemistry.Point(270, 470), 221, 383, canvas);
    sq.name = "porous_cell";
    scene.add(sq);
}
...
{
    question = [];
    question.push({ srno: 1, question: "Select <span style='color: #018fc3'>Burette</span>", ans: "burette", hint: ["Has Suction and Discharge", "Has valve attached", "Triangular Base"] });
    ...
    question.push({ srno: 3, question: "Select <span style='color: #018fc3'> Flask </span>", ans: "flask", hint: ["Rectangular", "Mounted Vertically", "Has valves attached"] });
    question.push({ srno: 4, question: "Select <span style='color: #018fc3'>Pipette</span>", ans: "pipette", hint: ["Double Pipe", "pipe inside a pipe", "Has two inlets and outlets"] });
    question.push({ srno: 5, question: "Select <span style='color: #018fc3'>Porous Cell</span>", ans: "porous_cell", hint: ["U-Shape", "Mounted horizontally", "Has two pins"] });
}
...
function load_higlighted_images() {
    highlighted_images = [
        ...
        [flask, flask],
        [pipette, pipette],
        [porous_cell, porous_cell],
    ];
    a1_labels = [
        new Chemistry.Text("burette", new Chemistry.Point(920, 100), canvas),
        new Chemistry.Text("beaker", new Chemistry.Point(1250, 100), canvas),
        new Chemistry.Text("flask", new Chemistry.Point(1650, 100), canvas),
        new Chemistry.Text("pipette", new Chemistry.Point(600, 100), canvas),
        new Chemistry.Text("porous_cell", new Chemistry.Point(270, 100), canvas),
    ];
}
