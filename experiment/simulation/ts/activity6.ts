...
function act6_verify_tab1() {
  let val1: HTMLInputElement = <HTMLInputElement> document.getElementById('a6-inp1');
  let val2: HTMLInputElement = <HTMLInputElement> document.getElementById('a6-inp2');
  let val3: HTMLInputElement = <HTMLInputElement> document.getElementById('a6-inp3');
...
function verify_summations() {
    let val1: HTMLInputElement = <HTMLInputElement>document.getElementById("act6-tab3-inp1");
    let val2: HTMLInputElement = <HTMLInputElement>document.getElementById("act6-tab3-inp2");
    let val3: HTMLInputElement = <HTMLInputElement>document.getElementById("act6-tab3-inp3");
